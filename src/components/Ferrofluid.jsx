// ReactBits Ferrofluid (reactbits.dev/backgrounds/ferrofluid), adapted:
// - pointermove listens on window (the container is pointer-events: none)
// - optional runningRef skips rendering while the layer is invisible
// - container CSS lives in App.css
...
export default function Ferrofluid({
  ...
  useEffect(() => {
    ...
    const loop = t => {
      ...
      if (runningRef && runningRef.current === false) return;
    ...
    mouseRadius, mouseDampening, runningRef,
  ]);

  return <div ref={containerRef} className={`ferrofluid-container ${className ?? ''}`} />;
}
